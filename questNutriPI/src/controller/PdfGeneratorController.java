	...
	public static void generate(Customer customer) {
		...
		if (userSelection == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				String fontPathBlue3 = QuestNutri.class.getResource("/view/assets/fonts/Montserrat-Bold.ttf")
						.toString();
				...
				Font fontBlue4 = FontFactory.getFont("Montserrat-BoldItalic-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue5 = FontFactory.getFont("Montserrat-ExtraBold-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue7 = FontFactory.getFont("Montserrat-ExtraLight-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);

				String fontPathBlue8 = QuestNutri.class
						.getResource("/view/assets/fonts/Montserrat-ExtraLightItalic.ttf").toString();
				...
				String fontPathBlue9 = QuestNutri.class.getResource("/view/assets/fonts/Montserrat-Italic.ttf")
						.toString();
				FontFactory.register(fontPathBlue9, "Montserrat-Italic-Blue");
				Font fontBlue9 = FontFactory.getFont("Montserrat-Italic-Blue", BaseFont.IDENTITY_H, BaseFont.EMBEDDED,
						14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue10 = FontFactory.getFont("Montserrat-Light-Blue", BaseFont.IDENTITY_H, BaseFont.EMBEDDED,
						14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue11 = FontFactory.getFont("Montserrat-LightItalic-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue13 = FontFactory.getFont("Montserrat-MediumItalic-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue14 = FontFactory.getFont("Montserrat-Regular-Blue", BaseFont.IDENTITY_H, BaseFont.EMBEDDED,
						14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue16 = FontFactory.getFont("Montserrat-SemiBoldItalic-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);

				String fontPathBlue17 = QuestNutri.class.getResource("/view/assets/fonts/Montserrat-Thin.ttf")
						.toString();
				FontFactory.register(fontPathBlue17, "Montserrat-Thin-Blue");
				Font fontBlue17 = FontFactory.getFont("Montserrat-Thin-Blue", BaseFont.IDENTITY_H, BaseFont.EMBEDDED,
						14, Font.NORMAL, BaseColor.BLUE);
				...
				Font fontBlue18 = FontFactory.getFont("Montserrat-ThinItalic-Blue", BaseFont.IDENTITY_H,
						BaseFont.EMBEDDED, 14, Font.NORMAL, BaseColor.BLUE);

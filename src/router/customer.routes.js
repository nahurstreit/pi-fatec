...
export default class CustomerRoutes {
    ...
    routes() {
        ...
        .post((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal', method: 'post'}))
        .get((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal', method: 'get'}))
        .delete((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal', method: 'delete'}))
        .put((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal', method: 'put'}))
        ...
        .post((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood', method: 'post'}))
        .get((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood', method: 'get'}))
        .delete((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood', method: 'delete'}))
        .put((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood', method: 'put'}))
        ...
        .post((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood/subfood[s]?/:idSubFood', method: 'post'}))
        .get((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood/subfood[s]?/:idSubFood', method: 'get'}))
        .delete((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood/subfood[s]?/:idSubFood', method: 'delete'}))
        .put((res,res) => res.status(200).json({path: '/:idCustomer/meal[s]?/:idMeal/food[s]?/:idFood/subfood[s]?/:idSubFood', method: 'put'}))
